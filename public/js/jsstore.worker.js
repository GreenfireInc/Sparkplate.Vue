/*!
 * @license :jsstore - V4.4.5 - 10/10/2022
...
;(() => {
  ...
  var TableMeta = /** @class */ (function () {
    ...
    TableMeta.prototype.setColumn = function (tableColumns) {
      ...
      var _loop_1 = function (columnName) {
        ...
        column.enableSearch =
          column.enableSearch == null ? true : column.enableSearch
    ...
    LogHelper.prototype.getMsg_ = function () {
      ...
      var errorHandler =
        ...
        (_a[ERROR_TYPE.ColumnNotExist] = function () {
          ...
          errMsg = info['isOrder']
            ? true && info.isJoin
              ? "Column '".concat(
                  column,
                  "' in order query is invalid. Please use '<table>.<column>' format for specifying a column in join query."
                )
        ...
        (_a[ERROR_TYPE.NullValue] = function () {
          errMsg =
            "Null value is not allowed for column '" + info['ColumnName'] + "'"
        }),
        ...
        (_a[ERROR_TYPE.DbNotExist] = function () {
          errMsg = 'Database with name '.concat(
            info['dbName'],
            ' does not exist'
          )
        }),
        ...
        (_a[ERROR_TYPE.NullValueInWhere] = function () {
          errMsg = "Null/undefined is not allowed in where. Column '".concat(
            info['column'],
            "' has null"
          )
        }),
            ...
            for (var i = oldVersion + 1; i <= dbVersion; i++) {
              ...
              if (alterQuery) {
                ...
                forObj(alterQuery.modify || {}, function (columnName, column) {
                  var shouldDelete =
                    column.multiEntry || column.keyPath || column.unique
      ...
      if (!query.from && query.store && query.meta) {
        ...
        if (true) {
          if (primaryKey == null) {
            delete query.store
            console.warn(
              'no primary key found for query - '.concat(
        ...
        if (table == null && query.store) {
          ...
          if (!metaValue || !metaValue.primaryKey) {
            console.warn(
              'no primary key found for query - '.concat(
                JSON.stringify(this.query),
                '. Please supply primary key in meta field.'
              )
            )
          }
        }
  ...
  var ValuesChecker = /** @class */ (function () {
    ...
    ValuesChecker.prototype.checkNotNullAndDataType_ = function (
      column,
      value
    ) {
    ...
    SchemaChecker.prototype.checkByColumn_ = function (column, value) {
      ...
      if (column.dataType && checkFurther) {
        if (type !== column.dataType && type !== 'object') {
          return new LogHelper(ERROR_TYPE.WrongDataType, {
            column: column.name
          })
        }
      }
  ...
  var QueryHelper = /** @class */ (function () {
    ...
    QueryHelper.prototype.isInsertQryValid = function (query) {
      ...
      if (table) {
        ...
        log = new LogHelper(ERROR_TYPE.TableNotExist, {
    ...
    QueryHelper.prototype.checkUpdate = function (query) {
      var err = new SchemaChecker(this.getTable_(query.in)).check(
        query.set,
        query.in
      )
      if (err) return err
    ...
    QueryHelper.prototype.checkForNullInWhere_ = function (query) {
      for (var columnName in query.where) {
        if (query.where[columnName] == null) {
          return new LogHelper(ERROR_TYPE.NullValueInWhere, {
            column: columnName
          })
        }
      }
      ...
      var addToSingleQry = function (qry, keys) {
        ...
        keys.forEach(function (prop) {
          ...
          if (value[QUERY_OPTION.NotEqualTo] != null) {
            ...
            qry[QUERY_OPTION.Or][prop][QUERY_OPTION.LessThan] =
              value[QUERY_OPTION.NotEqualTo]
    ...
    QueryHelper.prototype.checkInsertQuery = function (query) {
      ...
      var valueCheckerInstance = new ValuesChecker(
        table,
  ...
  var Insert = /** @class */ (function (_super) {
    ...
    return Insert
  })(Base) // CONCATENATED MODULE: ./src/worker/utils/set_cross_browser_idb.ts
  ...
  var IS_WORKER =
    typeof self.alert === 'undefined' &&
    typeof ServiceWorkerGlobalScope === 'undefined'
  var IS_IDB_SUPPORTED = setCrossBrowserIndexedDb() // CONCATENATED MODULE: ./src/worker/utils/is_array.ts
    ...
    if (caseQuery) {
      this.pushResult = function (value) {
        ...
        for (columnName in caseQuery) {
          value[columnName] = _this.thenEvaluator
  ...
  var ThenEvaluator = /** @class */ (function () {
    ...
    ThenEvaluator.prototype.setCaseAndColumn = function (
      caseQuery,
      columnName
    ) {
      this.caseQuery_ = caseQuery
    ...
    ThenEvaluator.prototype.checkCase_ = function (cond) {
      ...
      for (queryOption in cond) {
        switch (queryOption) {
          ...
          case QUERY_OPTION.Between:
            if (
              this.value[this.columnName_] > cond[queryOption].low &&
              this.value[this.columnName_] < cond[queryOption].high
            ) {
              return true
            }
            break
  ...
  var getCursorOnSuccess = function (
    simpleFn,
    limitFn,
    skipFn,
    skipAndLimitFn
  ...
  var executeWhereLogic = function (column, value, op, dir) {
    ...
    var cursorRequest = this.objectStore
      .index(column)
      .openCursor(this.util.keyRange(value, op), dir)
    var onSuccess = getCursorOnSuccess.call(
      this,
  ...
  var executeWhereUndefinedLogic = function () {
    ...
    if (orderQuery && orderQuery.idbSorting !== false && orderQuery.by) {
      if (objectStore.indexNames.contains(orderQuery.by)) {
        var orderType =
          orderQuery.type && orderQuery.type.toLowerCase() === 'desc'
            ? 'prev'
            : 'next'
        this.sorted = true
        cursorRequest = objectStore
          .index(orderQuery.by)
    ...
    switch (column.dataType) {
      ...
      default:
        return order.type === 'asc'
          ? compareDefaultinAsc_
          : compareDefaultInDesc_
    }
  }
    ...
    if (orderColumn != null && typeof orderColumn === DATA_TYPE.Object) {
      ...
      if (columnInfo != null) {
        ...
        if (order.case == null) {
          ...
          thenEvaluator.setCaseAndColumn(
            ((_a = {}), (_a[orderColumn] = order.case), _a),
            orderColumn
          )
          this.results.sort(function (a, b) {
            return orderMethod_1(
    ...
    if (order && this.results.length > 0 && !this.sorted) {
      ...
      if (orderQueryType === DATA_TYPE.Object) {
        ...
        var _loop_1 = function (i, length_1) {
          ...
          var orderColumnDetail = getOrderColumnInfo.call(
            this_1,
            currentorderQueryBy
          )
          if (orderColumnDetail != null) {
            ...
            var orderMethod_2 = getValueComparer_(
              orderColumnDetail,
              currentOrderQuery
            )
            this_1.results.sort(function (a, b) {
              if (a[prevOrderQueryBy] === b[prevOrderQueryBy]) {
                return orderMethod_2(
                  a[currentorderQueryBy],
                  b[currentorderQueryBy]
                )
              }
              return 0
            })
    ...
    for (var prop in aggregateQry) {
      ...
      switch (aggregateValType) {
        case DATA_TYPE.String:
          ...
          results[''.concat(prop, '(').concat(columnToAggregate, ')')] =
            aggregateCalculator()
          break
        case DATA_TYPE.Array:
  ...
  var processGroupBy = function () {
    ...
    if (groupByDataType !== DATA_TYPE.Object) {
      ...
      if (caseQueryLength === 1) {
        ...
        for (var i in datas) {
          lookUpObj.set(
            this.thenEvaluator.setValue(datas[i]).evaluate(),
            datas[i]
          )
        }
      } else {
  ...
  var executeAggregateGroupBy = function () {
    ...
    var calculateAggregate = function () {
      ...
      var getMax = function () {
        ...
        datas[index][columnToAggregate] = datas[index][columnToAggregate]
          ? datas[index][columnToAggregate]
          : 0
        // compare between old value and new value
        return value > datas[index][columnToAggregate]
          ? value
          : datas[index][columnToAggregate]
      }
      var getMin = function () {
      ...
      var getSum = function () {
        ...
        // add with old value if data exist
        value += datas[index][columnToAggregate]
          ? datas[index][columnToAggregate]
          : 0
        return value
      }
      var getAvg = function () {
        ...
        // add with old value if data exist
        sumOfColumn += datas[index][columnToAggregate]
          ? datas[index][columnToAggregate]
          : 0
      ...
      for (var prop in aggregateQry) {
        ...
        switch (aggregateValType) {
          case DATA_TYPE.String:
            columnToAggregate = aggregateColumn
            datas[index][''.concat(prop, '(').concat(columnToAggregate, ')')] =
              aggregateCalculator()
            break
          case DATA_TYPE.Array:
            for (var item in aggregateColumn) {
              ...
              datas[index][
                ''.concat(prop, '(').concat(columnToAggregate, ')')
              ] = aggregateCalculator()
            }
        }
      }
    ...
    if (avgQuery) {
      if (getDataType(avgQuery) === DATA_TYPE.String) {
        for (index in datas) {
          var sumForAvg = datas[index]['sum(' + avgQuery + ')'],
        ...
        var isCountTypeString =
          getDataType(aggregateQry.count) === DATA_TYPE.String
        var isSumTypeString = getDataType(aggregateQry.sum) === DATA_TYPE.String
        for (index in datas) {
          for (var column in avgQuery) {
            var avgColumn = avgQuery[column],
  ...
  var clone = function (obj) {
    if (clone_isObject(obj)) {
      ...
      for (var i in obj) {
        copy[i] =
          obj[i] != null && clone_isObject(obj[i]) ? clone(obj[i]) : obj[i]
      }
      return copy
    }
    return obj
  ...
  var WhereChecker = /** @class */ (function () {
    ...
    WhereChecker.prototype.checkComparisionOp_ = function (
      ...
      return (
        compare(value, compareValue.low, '>=') &&
  ...
  var BaseFetch = /** @class */ (function (_super) {
    ...
    BaseFetch.prototype.goToWhereLogic = function () {
      ...
      if (getDataType(value) === 'object') {
        var checkFlag = getLength(value) > 1 || getLength(whereQuery) > 1
        ...
        switch (key) {
          ...
          case QUERY_OPTION.Regex:
            return this.executeRegexLogic(
              firstColumn,
              value[QUERY_OPTION.Regex]
            )
          case QUERY_OPTION.In:
    ...
    return BaseFetch
  })(Base) // CONCATENATED MODULE: ./src/worker/executors/select/regex.ts
  ...
  var executeRegexLogic = function (column, exp) {
    ...
    this.shouldAddValue = function (cursor) {
      return exp.test(cursor.key) && _this.whereChecker.check(cursor.value)
    }
    ...
    var onSuccess = getCursorOnSuccess.call(
      ...
      executeSimpleForWhere_,
      executeLimitForWhere_,
      regex_executeSkipForWhere_,
      regex_executeSkipAndLimitForWhere_
    )
    return promise(function (res, rej) {
      cursorRequest.onerror = rej
  ...
  var executeInLogic = function (column, values) {
    ...
    var runInLogic = function (value) {
      return promise(function (res, rej) {
        var cursorRequest = _this.objectStore
          .index(column)
          .openCursor(_this.util.keyRange(value))
        cursorRequest.onsuccess = onSuccess.call(_this, res, skipOrPush)
        cursorRequest.onerror = rej
      })
    }
  ...
  var Join = /** @class */ (function () {
    ...
    Join.prototype.executeSelect = function (query) {
      ...
      return new Select(query, this.select.util).execute()
    }
    Join.prototype.execute = function () {
      var _this = this
      var query = this.query
      this.joinQueryStack_ =
        getDataType(query.join) === DATA_TYPE.Object ? [query.join] : query.join
    ...
    Join.prototype.jointables = function (
      joinQuery,
      jointblInfo,
      secondtableData
    ) {
      ...
      var performInnerJoin = function () {
        ...
        _this.results.forEach(function (valueFromFirstTable) {
          secondtableData.forEach(function (valueFromSecondTable) {
            if (
              valueFromFirstTable[table1Index][column1] ===
              valueFromSecondTable[column2]
            ) {
      ...
      var performleftJoin = function () {
        ...
        if (joinQuery.store) {
          ...
          _this
            .getTable(jointblInfo.table2.table)
        ...
        _this.results.forEach(function (valueFromFirstTable) {
          ...
          if (table2Index === 1) {
            ...
            callBack = function (valueFromSecondTable) {
              ...
              if (
                value != null &&
                value[column1] === valueFromSecondTable[column2]
              ) {
                valueMatchedFromSecondTable.push(valueFromSecondTable)
              }
            }
    ...
    Join.prototype.checkJoinQuery_ = function (jointblInfo, qry) {
      ...
      if (
        tableSchemaOf1stTable.columns.find(function (q) {
        ...
        err = new LogHelper(
          ERROR_TYPE.InvalidJoinQuery,
          'column '
            .concat(table1.column, ' does not exist in table ')
            .concat(table1.table)
        )
      } else if (
        tableSchemaOf2ndTable.columns.find(function (q) {
        ...
        err = new LogHelper(
          ERROR_TYPE.InvalidJoinQuery,
          'column '
            .concat(table2.column, ' does not exist in table ')
            .concat(table2.table)
        )
      }
      ...
      tableSchemaOf1stTable.columns.every(function (column) {
        ...
        if (columnFound != null && qry.as[columnFound.name] == null) {
          err = new LogHelper(
            ERROR_TYPE.InvalidJoinQuery,
            'column '
              .concat(column.name, ' exist in both table ')
              .concat(table1.table, ' & ')
              .concat(table2.table)
          )
          return false
        ...
        openCursor: function (keyRange) {
          ...
          var execute = function () {
            ...
            if (value) {
              ...
              if (
                columnValue &&
                (keyRange == null || keyRange.includes(columnValue))
              ) {
  ...
  var Select = /** @class */ (function (_super) {
    ...
    Select.prototype.processWhereArrayQry = function () {
      ...
      var isItemExist = function (keyValue) {
        return (
          output.findIndex(function (item) {
      ...
      var onSuccess = function () {
        if (operation === QUERY_OPTION.And) {
          ...
          if (output.length > 0) {
            _this.results = __spreadArray(
              __spreadArray([], output, true),
              _this.results,
              true
            )
    ...
    Select.prototype.orQuerySuccess_ = function () {
      this.orInfo.results = __spreadArray(
        __spreadArray([], this.orInfo.results, true),
        this.results,
        true
      )
  ...
  Select.prototype.setLimitAndSkipEvaluationAtEnd_ =
    setLimitAndSkipEvaluationAtEnd
  ...
  Select.prototype.processGroupBy = processGroupBy // CONCATENATED MODULE: ./src/worker/executors/count/not_where.ts
  ...
  var where_executeWhereLogic = function (column, value, op) {
    ...
    return promise(function (res, rej) {
      if (isWhereKeysLengthOne && objectStore.count) {
        cursorRequest = objectStore
          .index(column)
          .count(_this.util.keyRange(value, op))
        ...
        cursorRequest = objectStore
          .index(column)
          .openCursor(_this.util.keyRange(value, op))
  ...
  Count.prototype.executeWhereUndefinedLogic =
    not_where_executeWhereUndefinedLogic
  Count.prototype.executeWhereLogic = where_executeWhereLogic
  Count.prototype.executeRegexLogic = regex_executeRegexLogic
  Count.prototype.executeInLogic = in_executeInLogic // CONCATENATED MODULE: ./src/worker/utils/resolve.ts
  ...
  var update_not_where_executeWhereUndefinedLogic = function () {
    ...
    return promise(function (res, rej) {
      cursorRequest.onsuccess = function (e) {
        ...
        if (cursor) {
          try {
            var cursorUpdateRequest = cursor.update(
              updateValue(_this.query, cursor.value)
            )
  ...
  var update_where_executeWhereLogic = function (column, value, op) {
    ...
    var cursorRequest = this.objectStore
      .index(column)
      .openCursor(this.util.keyRange(value, op))
    return promise(function (res, rej) {
      cursorRequest.onsuccess = function (e) {
        var cursor = e.target.result
        if (cursor) {
          if (_this.whereChecker.check(cursor.value)) {
            try {
              var cursorUpdateRequest = cursor.update(
                updateValue(query, cursor.value)
              )
              cursorUpdateRequest.onsuccess = function () {
                ++_this.rowAffected
                cursor.continue()
  ...
  var Update = /** @class */ (function (_super) {
    ...
    function Update(query, util) {
      ...
      if (mapSet) {
        var method =
          getDataType(mapSet) === DATA_TYPE.String
            ? variableFromPath(mapSet)
            : mapSet
        if (!method) {
    ...
    Update.prototype.executeComplexLogic_ = function () {
      ...
      return selectObject.execute().then(function (results) {
        ...
        var whereQry =
          ((_a = {}),
          (_a[key] = ((_b = {}), (_b[QUERY_OPTION.In] = inQuery), _b)),
          _a)
  ...
  Update.prototype.executeWhereUndefinedLogic =
    update_not_where_executeWhereUndefinedLogic
  ...
  Update.prototype.executeInLogic = update_in_executeInLogic // CONCATENATED MODULE: ./src/worker/intersect/index.ts

  var intersect_extends =
    (undefined && undefined.__extends) ||
    (function () {
      var extendStatics = function (d, b) {
        extendStatics =
  ...
  var Intersect = /** @class */ (function (_super) {
    ...
    return Intersect
  })(Base) // CONCATENATED MODULE: ./src/worker/executors/drop_db.ts
  ...
  var Union = /** @class */ (function (_super) {
    ...
    return Union
  })(Base) // CONCATENATED MODULE: ./src/worker/executors/remove/not_where.ts
  ...
  var Remove = /** @class */ (function (_super) {
    ...
    Remove.prototype.processWhereArrayQry = function () {
      ...
      return selectObject.execute().then(function (results) {
        ...
        var whereQry =
          ((_a = {}),
          (_a[pkey] = ((_b = {}), (_b[QUERY_OPTION.In] = keyList), _b)),
          _a)
  ...
  Remove.prototype.executeWhereUndefinedLogic =
    remove_not_where_executeWhereUndefinedLogic
  Remove.prototype.executeWhereLogic = remove_where_executeWhereLogic
  Remove.prototype.executeRegexLogic = remove_regex_executeRegexLogic // CONCATENATED MODULE: ./src/worker/executors/clear/index.ts
  ...
  var Clear = /** @class */ (function (_super) {
        ...
        try {
          return promise(function (res, rej) {
            clearRequest.onsuccess = function (e) {
              ...
              MetaHelper.set(MetaHelper.dbSchema, _this.util.db, _this.util)
                .then(function () {
                  res()
                })
                .catch(rej)
    ...
    return Clear
  })(Base) // CONCATENATED MODULE: ./src/worker/executors/transaction/index.ts

  var transaction_extends =
    (undefined && undefined.__extends) ||
    (function () {
      var extendStatics = function (d, b) {
        extendStatics =
  ...
  var Transaction = /** @class */ (function (_super) {
    ...
    return Transaction
  })(Base) // CONCATENATED MODULE: ./src/worker/utils/db_schema.ts
  ...
  var QueryManager = /** @class */ (function () {
    ...
    QueryManager.prototype.executeMiddleware_ = function (request) {
      ...
      return promise(function (res) {
        ...
        var callNextMiddleware = function () {
          if (index <= lastIndex) {
            var promiseResult = variableFromPath(_this.middlewares[index++])(
              request,
              middlewareContext
            )
    ...
    QueryManager.prototype.executeQuery = function (request, cb) {
      ...
      var callAPI = function (api, beforeExecute) {
        queryResult = new api(query, idbutil).execute(beforeExecute)
      }
      switch (request.name) {
        case API.OpenDb:
          cb()
    ...
    QueryManager.prototype.run = function (request) {
      ...
      this.executeMiddleware_(request)
        .then(function (_) {
          return _this
            .executeQuery(request, function () {
              return _this.callMiddleware_(beforeExecuteCallback)
            })
            .then(function (result) {
              return _this
                .callMiddleware_(onResultCallback, result)
      ...
      return promise(function (res, rej) {
        _this.util
          ...
          .then(function (dbInfo) {
            if (dbInfo.isCreated) {
              MetaHelper.get(MetaHelper.dbSchema, _this.util).then(
                function (value) {
                  if (value) {
                  ...
                  MetaHelper.set(MetaHelper.dbSchema, dbMeta, _this.util).then(
                    function () {
                      res(dbInfo)
                    }
                  )
