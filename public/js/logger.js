    ...
    this.logger = winston.createLogger({
      ...
      transports: [
        new winston.transports.File({
          filename: `${require('electron').remote.app.getPath(
            'userData'
          )}/logs/downloader.log`, // Note: require('electron').remote is undefined when I include it in the normal imports
...
function switchConsoleToLogger() {
  new Logger()
